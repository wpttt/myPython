...
"""
============================================================================
DOS下或Batch脚本中此py脚本调用方式：python datediff.py 输入文件  输出文件
----------------------------------------------------------------------------
说明:
本脚本主要用于计算发震间
...
## 设置变量的接收方式，为python datediff.py 输入文件
infile = sys.argv[1]
outfile = sys.argv[2]
...
df22['datetime2'] = df22['datetime'].shift()  # 新建时间列，将其设置为上一行的时间
